        ...
        <div className="wrapper">
          <div className="lg:max-w-md">
            ...
            <div className="space-y-5 mt-7 pe-10">
              <p>
                次世代のAppleシリコン{" "}
                <span className="text-white">M4をご紹介します</span>。
              </p>
              <p>
                M4はiPad Pro上でApple
                Intelligenceを駆動し、より簡単に文章を書き、創造し、そしてより多くのことを成し遂げられるようにします。信じられないほど薄く、軽く、そしてパワフルなデザインの中にすべてが詰まっています。
              </p>
              <p>
                まったく新しいディスプレイエンジンが、息をのむほどの精度、色再現性、輝度を実現。さらに次世代GPUはハードウェアアクセラレーションによるレイトレーシングを備え、コンソールレベルのグラフィックスをあなたの指先に届けます。
              </p>
              <p className="text-primary">
                Apple Intelligenceについて詳しく見る
              </p>
            </div>
          </div>
